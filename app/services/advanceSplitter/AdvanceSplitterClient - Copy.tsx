...
export default function AdvanceSplitterClient() {
  ...
  const [isGuitarPaused, setIsGuitarPaused] = useState(true);
  const [isPianoPaused, setIsPianoPaused] = useState(true);
          ...
          <div className="py-12 md:py-20">
            ...
            <div className="pb-12 text-center">
              ...
              <p className="text-lg mt-4 text-gray-300 max-w-3xl mx-auto">
                Split your audio into vocals, drums, bass, guitar, piano, and Strings/Pads components with Monaarch's cutting-edge audio separation technology.
              </p>
            </div>
...
{uploaded && !processing && splitTracks.vocals && (
  <div className="mt-10 space-y-12">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      {/* Guitar */}
      <div className="p-6 rounded-lg bg-cover bg-center bg-no-repeat border-dashed border-2 border-white">
        <h2 className="text-xl font-semibold mb-4 text-center">Guitar</h2>
        <div className="flex flex-col items-center">
          <div className="flex items-center space-x-4">
            <button
              onClick={() =>
      ...
      {/* Piano */}
      <div className="p-6 rounded-lg bg-cover bg-center bg-no-repeat border-dashed border-2 border-white">
        <h2 className="text-xl font-semibold mb-4 text-center">Piano</h2>
        <div className="flex flex-col items-center">
          <div className="flex items-center space-x-4">
            <button
              onClick={() =>
      ...
      {/* Others */}
      <div className="p-6 rounded-lg bg-cover bg-center bg-no-repeat border-dashed border-2 border-white">
        <h2 className="text-xl font-semibold mb-4 text-center">Strings/Pads</h2>
        <div className="flex flex-col items-center">
          <div className="flex items-center space-x-4">
            <button
              onClick={() =>
    ...
    >
      ...
      <div className="mt-6 flex justify-center">
        <a
          ...
          className={`px-6 py-3 ${downloadColor} text-white font-semibold rounded-full shadow-lg hover:${downloadColor.replace(
            "600",
            "700"
